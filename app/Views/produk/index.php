            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                ...
                <div>
                    <select name="price_range" class="form-select mt-1 block w-full px-3 py-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" onchange="this.form.submit()">
                        ...
                        <option value="0-50000" <?= ($params->price_range == "0-50000") ? 'selected' : '' ?>>
                            Rp0 - Rp50.000
                        </option>
                        <option value="50000-100000" <?= ($params->price_range == "50000-100000") ? 'selected' : '' ?>>
                            Rp50.000 - Rp100.000
                        </option>
                        <option value="100000-500000" <?= ($params->price_range == "100000-500000") ? 'selected' : '' ?>>
                            Rp100.000 - Rp500.000
                        </option>
                        <option value="500000-1000000" <?= ($params->price_range == "500000-1000000") ? 'selected' : '' ?>>
                            Rp500.000 - Rp1.000.000
                        </option>
                        <option value="1000000" <?= ($params->price_range == "1000000") ? 'selected' : '' ?>>
                            Rp1.000.000+
                        </option>
                    </select>
                </div>
