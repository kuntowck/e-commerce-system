...
<div class="bg-white shadow-sm rounded-lg p-8">
    ...
    <div>
        <a href="<?= base_url('product-manager/products/new'); ?>" class="px-4 py-2 bg-blue-500 text-white font-semibold text-sm rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            Create
        </a>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php foreach ($products as $product): ?>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="<?= base_url('product-manager/products/' . $product->id . '/show'); ?>" class="inline-block px-4 py-2 text-xs font-medium text-gray-900 focus:outline-none bg-white rounded-md border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                                Detail
                            </a>
                            <a href="<?= base_url('product-manager/products/' . $product->id . '/edit'); ?>" class="inline-block px-4 py-2 text-xs font-medium text-gray-900 focus:outline-none bg-white rounded-md border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                                Update
                            </a>
                            <form action="<?= base_url('product-manager/products/' . $product->id . '/delete'); ?>" method="post" class="inline-block">
                                <?= csrf_field(); ?>
